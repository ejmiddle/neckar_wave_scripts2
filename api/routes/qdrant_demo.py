...
router = APIRouter(prefix="/qdrant", tags=["qdrant-demo"])
...
def _request_json(method: str, url: str, payload: dict | None = None, timeout: int = 5):
    data = None
