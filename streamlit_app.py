...
FEATURE_PAGES = [
    {
        "id": "accounting",
        "path": "pages/Accounting.py",
        "title": "Accounting",
        "description": "sevDesk voucher and accounting type lookups",
        "icon": "🧮",
    },
    {
        "id": "accounting_backend",
        "path": "pages/accounting_backend.py",
        "title": "Accounting Backend",
        "description": "Support page for sevDesk master data maintenance",
        "icon": "🛠️",
    },
    {
        "id": "buchhaltung",
        "path": "pages/Buchhaltung.py",
        "title": "Buchhaltung",
    ...
    },
    {
        ...
        "path": "pages/Schichtplan_Management.py",
    ...
    },
    {
        ...
        "path": "pages/Trinkgeld_Management.py",
